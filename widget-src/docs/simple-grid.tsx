...
export function SimpleGridDoc() {
    ...
    return <AutoLayout name="Simple Grid Doc" {...docStyle}>
        ...
        <Text>
            Pass in a number to <Span {...codeStyle}>spacing</Span> prop to set the gap between rows and columns.
        </Text>
        ...
        <Text>
            Or assign <Span {...codeStyle}>spacingX</Span> and <Span {...codeStyle}>spacingY</Span> respectively.
        </Text>
