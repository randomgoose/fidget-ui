...
export function AvatarDoc() {
    return (
        <AutoLayout {...docStyle} name="avatar">
            ...
            <Text width={"fill-parent"}>Use Avatar component to display pictures, name initials or an default icon that represents a user.</Text>
            <Divider />
            <Code>
            ...
            <AutoLayout direction="vertical" width={"fill-parent"} spacing={16}>
                <Text width={"fill-parent"}>
                    - Pass in an <Span {...codeStyle}>src</Span> prop (like the built-in Image Component) to set the image that represents the user.
                </Text>
                <Text width={"fill-parent"}>
                    - If the <Span {...codeStyle}>src</Span> prop is not set, specify the <Span {...codeStyle}>name</Span> prop to display the initials of the given name. Otherwise, a default icon is displayed.
                </Text>
            </AutoLayout>

            <AutoLayout spacing={8}>
                <Avatar src={"https://images.pexels.com/photos/1084425/pexels-photo-1084425.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"} displayName="Chen Chen" fill={colors.blue[500]} />
            ...
            <Text width={"fill-parent"}>
                Set the <Span {...codeStyle}>fill</Span> prop to customize the background color of an Avatar.
            </Text>
            ...
            <Text width={"fill-parent"}>
                Avatar comes in with 5 predefined sizes: <Span {...codeStyle}>xs/sm/md/lg/xl</Span>. Or you can specify a number.
            </Text>
            <AutoLayout spacing={8}>
                {
                    ["xl", "lg", "md", "sm", "xs", 72].map(
                        size => <Avatar
            ...
            <AutoLayout direction="vertical" width={"fill-parent"} spacing={16}>
                ...
                <Text width={"fill-parent"}>
                    - Enable <Span {...codeStyle}>stacked</Span> prop to stack avatars. Or specify <Span {...codeStyle}>spacing</Span> to adjust the spacing between avatars.
                </Text>
            </AutoLayout>
