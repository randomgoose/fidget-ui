import { Avatar, Button, DescriptionList, Select, Tag, TextField } from "../components"
...
export function Issue() {
    ...
    const items: DescriptionListItem[] = [
        {
            ...
            value: <Select
                width={240}
                id="nkw3"
                options={users.map(({ id, name }) => ({ label: name, value: id }))} placement={"top"} />
        },
        {
            label: "Due Time",
        ...
        {
            label: "Status",
            value: <Tag size="sm" variant={"subtle"} colorScheme={"orange"}>Pending</Tag>
        },
        {
            label: "Project",
            value: "Test"
    ...
    return (
        <AutoLayout
            ...
            spacing={24}
        >
            <TextField width={"fill-parent"} value={title} onTextEditEnd={e => setTitle(e.characters)} variant={"flush"} />
