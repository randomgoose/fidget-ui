  ...
  return (
    <AutoLayout {...docStyle} name={'Intro'}>
      <AutoLayout verticalAlignItems={'center'} width={'fill-parent'}>
        <Heading as="h1" width={'fill-parent'}>
          Fidget UI
        </Heading>
...
>
      ...
      <P>
        This widget itself contains documents for colors, styles and components of Fidget UI. There
        are also two exmaple widgets to demonstrate the usage of components. Navigate to other pages
        with the property menu.
      </P>
    </AutoLayout>
  );
}
