import { Heading, Divider, IconButton } from '../src/components';
import { ButtonSize } from '../src/components/button/interface';
import { docStyle } from './styles';
import { P, Pre } from './typography';
import { IconGlobeAlt, IconAcademicCap, IconCog6Tooth } from '../src/icons';
...
export function IconButtonDoc() {
  return (
    <AutoLayout {...docStyle} name={'Icon Button Doc'}>
      ...
      <AutoLayout spacing={4}>
        {['sm', 'md', 'lg'].map((size) => (
          <IconButton key={size} icon={<IconAcademicCap />} size={size as ButtonSize} />
        ))}
      </AutoLayout>
