import { Heading, IconButton, TextField, Checkbox, colors } from 'fidget-ui';
import { IconMagnifyingGlass, IconMinus, IconPlus } from 'fidget-ui/icons';
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        leftElement={<IconMagnifyingGlass width={16} height={16} color={colors.neutral[400]} />}
