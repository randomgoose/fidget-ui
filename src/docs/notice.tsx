    ...
    <AutoLayout {...docStyle} name={'Notice Doc'}>
      ...
      <AutoLayout direction="vertical" width={'fill-parent'} spacing={8}>
        ...
        <Notice
          ...
          status="error"
          title={'Error'}
          description={'Update failed. Check your network.'}
        />
        <Notice
          variant={'solid'}
          status="warning"
      ...
      <Notice
        title={
          'InfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfo'
        }
        description={
          'Component updates available.mponent updates available.mponent updates available.mponent updates available.mponent updates available.mponent updates available.mponent updates available.mponent updates available.'
        }
        icon={<IconBookmarkSolid />}
      />

      <Notice title={'Info'} description={'Component updates available.'} icon={false} />

      <Notice title={'Info'} icon={false}>
